...
def validate_html(html):
    ...
    # and the code from class will be that you wil
    # l have to keep track of not just the 3 types of parentheses,
...
def _extract_tags(html):
    ...
    By convention in Python, helper functions tha
    t are not meant to be used directly
    by the user are prefixed with an underscore.

    This function returns a list of all the
    html tags contained in the input string,
    stripping out all text
